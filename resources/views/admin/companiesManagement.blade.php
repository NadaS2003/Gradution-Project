    ...
    <div class="mt-5 mr-5 ml-8 mb-6">
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="border border-gray-300 px-4 py-2">www.company.com</td>
                <td class="border border-gray-300 px-4 py-2">شركة مختصصة بتطوير البرمجيات أنواعها بطرق مميزة </td>
                <td class="border border-gray-300 px-4 py-2">غزة-الرمال- شارع الوحدة</td>
                <td class="border border-gray-300 px-4 py-2">sed@gmail.com</td>
