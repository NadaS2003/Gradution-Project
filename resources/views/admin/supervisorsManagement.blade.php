    ...
    <div class="mt-5 mr-5 ml-8 mb-6">
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tr class="hover:bg-gray-50">
                <td class="border border-gray-300 px-4 py-2"> محمد سالم محمود احمد</td>
                <td class="border border-gray-300 px-4 py-2">120789364</td>
                <td class="border border-gray-300 px-4 py-2">علم حاسوب</td>
                <td class="border border-gray-300 px-4 py-2">mSalem@gmail.com</td>
