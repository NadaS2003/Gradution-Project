            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="border border-gray-300 px-4 py-2">
                    <div class="inline-flex space-x-2 gap-2">
                        <button class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">كتاب التدريب</button>
                    </div>
                </td>
            </tr>
            <tr class="hover:bg-gray-50">
                ...
                <td class="border border-gray-300 px-4 py-2 text-red-600 font-bold">لم يتم رفع الكتاب بعد</td>
            </tr>
            </tbody>
        </table>
    </div>
