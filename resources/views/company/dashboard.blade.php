...
@section('content')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 rounded">
            <div class="flex flex-col text-right">
                <div class="card-box text-white px-10 h-40 rounded-lg flex flex-col justify-center items-start" style="background-color:rgb(0, 118, 223);">
                    <h3 class="text-xl font-bold mb-3 ">عدد الفرص </h3>
    ...
    <div class="my-4 mt-6 mr-8 ml-8 mb-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
            <div class="card p-3 border border-e-black border-opacity-15 py-8 px-5 rounded mb-5 flex flex-col items-center justify-center" style="height: 400px;">
                <h2 class="text-center text-2xl font-bold mb-2">نسبة الحضور والغياب</h2>

                @if($attendanceCounts['حاضر'] == 0 && $attendanceCounts['غائب'] == 0)
                    <p class="text-center text-lg text-red-500">لا توجد بيانات لحضور وغياب الطلاب في هذه الشركة.</p>
                @else
            ...
            <div class="card p-3 border border-e-black border-opacity-15 py-8 px-5 rounded mb-5 flex flex-col items-center justify-center" style="height: 400px;"> <!-- إضافة flexbox -->
                ...
                @if($studentsPerOpportunity->isEmpty() && $internshipsCount == 0)
                    <p class="text-center text-lg text-red-500">لا توجد فرص تدريبية مضافة من قبل الشركة.</p>
                @elseif($studentsPerOpportunity->isEmpty())
                    <p class="text-center text-lg text-red-500">لا يوجد طلاب في الفرص التدريبية الحالية.</p>
                @else
